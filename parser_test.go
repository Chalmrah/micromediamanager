...
func TestParseFilename(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "ordinal season in title",
			filename:     "[Erai-raws] Kabushikigaisha Magilumiere 2nd Season - 01 [1080p AMZN WEB-DL AVC EAC3][MultiSub][A10E7CBD].mkv",
			wantTitle:    "Kabushikigaisha Magilumiere",
			wantSeason:   2,
			wantEpNum:    1,
			wantExplicit: true,
		},
		{
			name:         "ordinal season 3rd",
			filename:     "[Erai-raws] Some Show 3rd Season - 12 [1080p].mkv",
			wantTitle:    "Some Show",
			wantSeason:   3,
			wantEpNum:    12,
			wantExplicit: true,
		...
		{
			name:         "written season number",
			filename:     "[SubGroup] Another Show Season 2 - 05 (1080p).mkv",
			wantTitle:    "Another Show",
			wantSeason:   2,
			wantEpNum:    5,
			wantExplicit: true,
		},
